...
const ConnectUs = () => {
    return (
        ...
        <section style={{background:`url(${appointment})`}} class="w-full max-w-2xl px-6 py-4 mx-auto  rounded-md shadow-md">
        <h2 class="text-3xl font-semibold text-center text-primary dark:text-white">Get in touch</h2>
        <p class="mt-3 text-center text-white dark:text-gray-400">Lorem ipsum dolor sit amet consectetur, adipisicing elit.</p>
        
        <div class="grid grid-cols-1 gap-6 mt-6 sm:grid-cols-2 md:grid-cols-3">
            <a href="#" class="flex flex-col items-center px-4 py-3 text-white transition-colors duration-200 transform rounded-md dark:text-gray-200 hover:bg-blue-200 dark:hover:bg-blue-500">
        ...
        <div class="mt-6 ">
            <div class="items-center -mx-2 md:flex">
                <div class="w-full mx-2">
                    <label class="block mb-2 text-sm font-medium text-white dark:text-gray-200">Name</label>
                ...
                <div class="w-full mx-2 mt-4 md:mt-0">
                    <label class="block mb-2 text-sm font-medium text-white dark:text-gray-200">E-mail</label>
            ...
            <div class="w-full mt-4">
                <label class="block mb-2 text-sm font-medium text-white dark:text-gray-200">Message</label>
            ...
            <div class="flex justify-center mt-6">
                <button class="px-4 py-2 text-white transition-colors duration-200 transform bg-primary rounded-md hover:bg-secondary focus:outline-none focus:bg-secondary">Send Message</button>
            </div>
        </div>
    </section>
    );
